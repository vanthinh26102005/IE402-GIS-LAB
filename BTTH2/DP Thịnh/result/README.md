...
The implementation is based on the ArcGIS JavaScript patterns already used in `arcgis-sample/lab2`, but the result is not a single simple extrusion. It adds visible architectural detail so the building reads as **LoD 3-like** from normal viewing angles.
